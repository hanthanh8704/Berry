...
const MenuCustomer = () => {
    const cartItemsCount = 5; // Example item count for the cart

    return (
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
            <div className="container d-flex" style={{ justifyContent: 'space-around', alignItems: 'center' }}>
                <div className='imgages'>
                    <Link className="navbar-brand d-flex align-items-center" to="/home">
                        ...
                        <h4 className="navbar-title ms-2">BERRY</h4>
                    </Link>
                </div>
                <div className='search'>
            <div className="navbar-search d-flex">
                <div className="input-group">
                    <span className="input-group-text" style={{ backgroundColor: 'white', borderLeft: '1px solid #6A0DAD',  borderBottom: '1px solid #6A0DAD', borderTop: '1px solid #6A0DAD', borderRadius: '20px 0px 0px 20px' }}>
                        <IconSearch size={24} color="#6A0DAD" />
                    </span>
                    <input style={{ borderRadius: '0px 20px 20px 0px', width: '500px', height: '44px', borderLeft: '1px solid white' , borderTop: '1px solid #6A0DAD' , borderBottom: '1px solid #6A0DAD' , borderRight: '1px solid #6A0DAD'}} className="form-control" type="search" placeholder="Tìm kiếm..." aria-label="Search" />
                </div>
                <button className="btn absiluton" type="button" style={{ backgroundColor: '#6A0DAD', color: 'white', borderRadius: '20px', marginLeft: '-2px' }}>
                    SEARCH
                </button>
            </div>
        </div>
