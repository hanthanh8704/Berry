                ...
                <div className="row1" style={{ marginRight: 'px', marginLeft: '40px' ,width: '500px' }}>
                    <div className="row">
                        <div className="col-md-12 text-center">
                            <svg width="46" height="55" viewBox="0 0 46 55" fill="none" xmlns="http://www.w3.org/2000/svg" className='mb-3'>
                    ...
                    <div className="row">
                        ...
                        <div className="row">
                            <div className="" style={{ marginTop: '70px' }}>
                                ...
                                <p> <div className='my-2'>Chúng tôi luôn trân trọng và mong đợi nhận được mọi<br /> </div>
                                    <div className='my-2'>  ý kiến đóng góp của khách hàng để có thể nâng cấp trải <br /> </div>
                                    <div className='my-2'>     nghiệm dịch vụ và sản phẩm tốt hơn nữa. </div>   </p>
                            </div>
                        </div>
                    </div>
