                ...
                <div className="row1" style={{ display: 'flex', justifyContent: 'space-around' }}>
                    <div className="row" style={{ marginLeft: '100px' }}>
                        ...
                        <div className='mt-4'>
                            ...
                            <ul className="list-unstyled">
                                <li className="mb-2">
                                    <a href="/chinh-sach/4" className="text-decoration-none">Chính sách trả hàng</a>
                                </li>
                                <li className="mb-2">
                                    <a href="/chinh-sach/5" className="text-decoration-none">Chính sách bảo mật</a>
                                </li>
                                <li className="mb-2">
                                    <a href="/chinh-sach/6" className="text-decoration-none">Chính sách thanh toán, giao nhận</a>
                                </li>
                                <li className="mb-2">
                                    <a href="/chinh-sach/7" className="text-decoration-none">Chính sách dành cho khách hàng</a>
                                </li>
                            </ul>
