...
const PhieuGiamGia = () => {
  ...
  const filteredOrders = dotGiamGia.filter(dotGiamGia =>
    ...
    dotGiamGia.customer.toLowerCase().includes(searchValue.toLowerCase()))
  );
              ...
              <TableBody>
                {paginatedOrders.map((dotGiamGia, index) => (
                  <TableRow key={dotGiamGia.id}>
                    ...
                    <TableCell>{dotGiamGia.code}</TableCell>
                    <TableCell>{dotGiamGia.customer}</TableCell>
                    <TableCell>{dotGiamGia.totalMoney} đ</TableCell>
                    <TableCell>{dotGiamGia.status}</TableCell>
                    <TableCell>
                      <Button variant="outlined" color="primary" onClick={() => handleViewDetails(dotGiamGia)}>
                        Chi tiết
                      </Button>
                    </TableCell>
                  </TableRow>
