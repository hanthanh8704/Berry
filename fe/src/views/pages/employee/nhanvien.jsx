import { Col, Input, Row, Table, Tooltip, Tag, Button, Select, message, notification } from 'antd';
    ...
    request
      .get('/nhan-vien', {
        params: {
          ...
          : null, // Chuyển searchValue thành định dạng SQL LIKE
          name: searchValue 
          ? `%${searchValue.trim().replace(/\s+/g, '%')}%` 
          : null, // Gán giá trị tên, tương tự như code
