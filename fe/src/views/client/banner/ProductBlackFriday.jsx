...
const ProductBlackFriday = () => {
    ...
    const fetchFilteredProducts = () => {
        ...
        console.log('product ddddddddddddd con me no ', product);
        axios
            .get(`http://localhost:8080/api/client/search/products/promotion`, {
                params: {
            ...
            .then(response => {
                setProduct(response.data); // Lưu trữ dữ liệu sản phẩm vào state
    ...
    const getAllProductPromoton = () => {
        axios
            .get(`http://localhost:8080/api/client/products/promotion`)
            .then((response) => {
                setProduct(response.data);
                console.log('product balck friday ', product);
            })
            .catch((error) => {
                console.error('Error fetching San Pham CT:', error);
                setProduct([]);
...
export default ProductBlackFriday;
