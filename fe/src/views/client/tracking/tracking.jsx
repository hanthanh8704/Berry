...
//             FindByMa(ma, sdt);
//         } else {
//             setHoaDon([]); // Reset hoaDon nếu không có giá trị tìm kiếm
//         }
...
//                 setHoaDon(Array.isArray(response.data) ? response.data : [response.data]); // Bảo đảm hoaDon là mảng
//             })
//             .catch(error => {
