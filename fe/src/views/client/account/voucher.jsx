...
const Vouchers = () => {
    ...
    const renderVoucherCard = (voucher) => (
        <Card
            ...
            actions={[
                <Button
                    onClick={() => handleShowPhieuGiamGia(voucher.id)}
        ...
        >
            <div style={{ fontSize: "14px", lineHeight: "1.6" }}>
                <Text strong style={{ color: "#6A0DAD", fontSize: "18px" }}>{voucher.name}</Text>
                <br />
                <Text>Giá trị: </Text>
                {voucher.discountMethod === 'PHAN_TRAM'
                    ? <Text>{voucher.discountValue}%</Text>
                    : <FormatCurrency value={voucher.discountValue} />
                }
                <br />
                <Text>Tối đa: <FormatCurrency value={voucher.maxDiscountValue} /></Text>
                <br />
                <Text>Tối thiểu: <FormatCurrency value={voucher.minOrderValue} /></Text>
            </div>
        </Card>
    );
                ...
                <Modal.Body>
                    ...
                    {voucherDetail && (
                        <div>
                            ...
                            <div className="d-flex align-items-center justify-content-between mb-4">
                                <div className="d-flex align-items-center">
                                    <img
                                        ...
                                        alt="BerryStore"
                                        style={{
                                            width: 150,   // Tăng kích thước ảnh
                                            height: 100,  // Tăng chiều cao ảnh
                                            marginRight: 15, // Tăng khoảng cách giữa ảnh và nội dung bên cạnh
                                ...
                                <div className="text-end">
                                    ...
                                    <p>Tối đa: <FormatCurrency value={voucherDetail.maxDiscountValue} /></p>
                                    <p>Tối thiểu: <FormatCurrency value={voucherDetail.minOrderValue} /></p>
                                </div>
                            </div>
                            ...
                            <div className='mb-3'>
                                <strong>Hạn sử dụng:</strong>
                                <p><FormatDate date={voucherDetail.startDate} />--   <FormatDate date={voucherDetail.endDate} /></p>
                            </div>
                            ...
                            <div className='mb-3'>
                                ...
                                <p>
                                    ...
                                    cho đơn từ <FormatCurrency value={voucherDetail.minOrderValue} /> {' '}
                                    đến <FormatCurrency value={voucherDetail.maxDiscountValue} />
                                </p>
                            </div>
                            ...
                            <div className='mb-3'>
                                ...
                                <p>Kiểu: {voucherDetail.type == 'CONG_KHAI' ? 'Công khai' : 'Cá nhân'}</p>
                                <p>Loại: {voucherDetail.discountMethod == 'CO_DINH' ? 'Cố định' : 'Phần trăm'}</p>
