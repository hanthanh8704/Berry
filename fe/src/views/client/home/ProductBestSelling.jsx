...
const ProductBestSelling = () => {
    ...
    const fetchFilteredProducts = () => {
        axios
            .get(`http://localhost:8080/api/client/search/products-best-selling`, {
                params: {
            ...
            .then(response => {
                setProductDetailSell(response.data); // Lưu trữ dữ liệu sản phẩm vào state
                console.log('Sản phẩm tìm kiếm:', response.data);
            })
            .catch(error => {
                if (error.response) {
