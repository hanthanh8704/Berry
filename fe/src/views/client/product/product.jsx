...
const Product = () => {
    ...
    const getAllThuongHieu = () => {
        findAllThuongHieu()
            .then((response) => {
                ...
                console.log('product eeeeeeeeeeeeeeeeeeeee', response.data);
            })
            .catch((error) => {
    ...
    const getAllMauSac = () => {
        findAllMauSac()
            .then((response) => {
                ...
                console.log('mau sac ddddddddddddddddddddddddddddd', response.data);
            })
            .catch((error) => {
                console.error('Error fetching San Pham CT:', error);
            });
    ...
    const getAllSanPhamById = () => {
        getAllProductsByIdDM(id)
            .then((response) => {
                setProduct(response.data);
                console.log('producteeeeeeeeeeeeeeeeeedddddddddddddddzzzzzzzzz', response.data);
            })
            .catch((error) => {
                console.error('Error fetching San Pham CT:', error);
                setProduct([]);
