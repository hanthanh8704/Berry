...
//    List<VoucherCustomer> findAllByBill(@Param("idHD") Integer id);
    ...
    //    @Query("select khvc from  VoucherCustomer khvc where" +
//            " khvc.customer =:idkh and khvc.voucher =:id")
//    VoucherCustomer findByIdKhachHangAndIdPhieuGiamGia(@Param("idkh") Integer idAccount, @Param("id") Integer idVoucher);
    ...
    List<VoucherCustomer> findByIdPhieuGiamGiaAndTrangThai(@Param("id") Integer voucherId, @Param("trangThai") String trangThai);
