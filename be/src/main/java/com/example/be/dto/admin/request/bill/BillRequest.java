...
public class BillRequest {
    ...
    private StatusPayMents paymentStatus; // Trạng thái thanh toán
    ...
    private String typeVoucher; // Mã voucher giảm giá
    private String detailAddress; // Địa chỉ nhận hàng
