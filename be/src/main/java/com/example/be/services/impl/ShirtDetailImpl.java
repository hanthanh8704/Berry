...
public class ShirtDetailImpl implements ShirtDetailService {
    ...
    public String create(List<ShirtDetailRequest> list) {
        ...
        for (ShirtDetailRequest request : list) {
            ...
            ProductDetail convert = shoeDetailConvert.convertRequestToEntity(request);
    ...
    public ProductDetail update(Integer id, UpdateShirtDetailRequest request) {
        ...
        old.setDetailCode(GenCodee.genCodeByName(old.getProduct().getCode()
                + request.getColor() + request.getSize() + request.getSleeve()));
    ...
    public ResponseObject updateFast(List<ShirtDetailRequest> list) {
        for (ShirtDetailRequest request : list) {
            ProductDetail convert = shoeDetailConvert.convertRequestToEntityFast(shirtDetailRepository.findById(request.getId()).get(), request);
