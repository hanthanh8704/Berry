...
public class AddressImpl implements AddressService {
    ...
    @Override
    public Address getByAccountid(Integer id) {
        return addressRepository.findByIdCustomer1(id);
    }
    ...
    public Address create(AddressRequest request) {
        ...
        System.out.println("Id KhachHang: " + request.getIdCustomer());
        ...
        Customer customer = customerRepository.findById(request.getIdCustomer())
                .orElseThrow(() -> new RuntimeException("Không tìm thấy KhachHang với id: " + request.getIdCustomer()));
    ...
    public Address update(Integer id, AddressRequest request) {
        ...
        if (request.getIdCustomer() != null) {
            Customer customer = customerRepository.findById(request.getIdCustomer())
                    .orElseThrow(() -> new RestApiException("Không tìm thấy KhachHang với id: " + request.getIdCustomer()));
            diaChiToUpdate.setCustomer(customer);
            System.out.println("ID Khach hang: " + request.getIdCustomer());
        }
        ...
        diaChiToUpdate.setDeleted(false);
